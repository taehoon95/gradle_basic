...
set CLASSPATH=%APP_HOME%\lib\UserUI-bin-1.0.jar;%APP_HOME%\lib\mysql-connector-java-5.1.49.jar


@rem Execute lib
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LIB_OPTS%  -classpath "%CLASSPATH%" gradle_basic.StudentUI %*
